...
const SYSTEM = [
  ...
  "Open DIRECTLY with the first topic subsection — do NOT add a top-level heading",
  "of your own (no '## What we discussed', no '## Summary'): the pipeline files this",
  "under its own '## Summary (Quick brief)' section, so a second top heading renders",
  "as an empty duplicate. Mirror the narrative language per the LANGUAGE rule below.",
  "```",
